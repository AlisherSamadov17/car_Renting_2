...
func (h Handler) CreateCustomer(c *gin.Context) {
	...
	id, err := h.Store.Customer().Create(context.Background(),customer)
	if err != nil {
...
func (h Handler) UpdateCustomer(c *gin.Context) {
	...
	id, err := h.Store.Customer().UpdateCustomer(context.Background(),customer)
...
func (h Handler) GetAllCustomer(c *gin.Context) {
	...
	customers, err := h.Store.Customer().GetAllCustomer(context.Background(),request)
	if err != nil {
...
func (h Handler) GetByIDCustomer(c *gin.Context) {
	...
	customer, err := h.Store.Customer().GetByID(context.Background(),id)
	if err != nil {
...
func (h Handler) DeleteCustomer(c *gin.Context) {
	...
	err = h.Store.Customer().Delete(context.Background(),id)
	if err != nil {
